...
class FeedIcecatMappingAdminController extends ModuleAdminController
{
	...
	public function initContent()
	{
		...
		$this->context->controller->addJS($_path . '/js/feedIcecatMapping.js');
		$this->context->smarty->assign([
			'mapping_ajax_link' => $this->context->link->getAdminLink('FeedIcecatMappingAdmin'),
			'suppliers' => $suppliers,
			'brands' => $brands,
